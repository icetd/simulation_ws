...
"""autogenerated by genpy from manager_msgs/Pose.msg. Do not edit."""
import codecs
import sys
...
class Pose(genpy.Message):
  ...
  _type = "manager_msgs/Pose"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """Point position
...
"""
  ...
  _slot_types = ['manager_msgs/Point','manager_msgs/Quaternion']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.position is None:
        self.position = manager_msgs.msg.Point()
      if self.orientation is None:
        self.orientation = manager_msgs.msg.Quaternion()
    else:
      self.position = manager_msgs.msg.Point()
      self.orientation = manager_msgs.msg.Quaternion()
