...
(cl:defmethod cl:initialize-instance :after ((m <Quaternion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Quaternion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name manager_msgs-msg:<Quaternion> is deprecated: use manager_msgs-msg:Quaternion instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manager_msgs-msg:x-val is deprecated.  Use manager_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manager_msgs-msg:y-val is deprecated.  Use manager_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manager_msgs-msg:z-val is deprecated.  Use manager_msgs-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manager_msgs-msg:w-val is deprecated.  Use manager_msgs-msg:w instead.")
  (w m))
